...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="w-full px-4 pt-4 pb-4 min-h-screen" onClick={() => showSortMenu && setShowSortMenu(false)}>
      ...
      {/* Grid */}
      <div className="bg-surface-light dark:bg-surface-dark rounded-3xl p-4 shadow-soft">
      ...
      <div className="fixed bottom-24 right-6 z-40">
        <button 
            onClick={() => {/* Logic to handle quick deposit or nav to goals */}}
